...
export const MainPageBox = (props:BoxProps) => {
    return (
        <div className="relative w-auto h-[500px] flex items-center justify-start flex-col  flex-wrap overflow-hidden">
            ...
            <h1 className="z-10 text-white font-bold text-3xl">{props.text1}</h1>
            <h1 className="z-10  text-white font-extrabold text-3xl">{props.text2}</h1>
            </div>
